...
PROJECT_ID = "vvns-bigquery"
REGION = "us-east1"
CLUSTER_NAME = "my-demo-cluster1"
COMPOSER_BUCKET = "us-south1-vvns-composer-23d359fd-bucket" ## change this 

GCS_JOB_FILE_1 = f"gs://{COMPOSER_BUCKET}/data/INGESTION/HighmarkHealthMySQLToLanding.py"
PYSPARK_JOB_1 = {
...
GCS_JOB_FILE_2 = f"gs://{COMPOSER_BUCKET}/data/INGESTION/ClevelandClinicMySQLToLanding.py"
PYSPARK_JOB_2 = {
    "reference": {"project_id": PROJECT_ID},
    "placement": {"cluster_name": CLUSTER_NAME},
...
with DAG(
    ...
    default_args=ARGS,
    tags=["pyspark", "dataproc", "etl", "mavericks"]
) as dag:
