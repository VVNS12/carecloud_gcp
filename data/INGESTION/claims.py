...
# configure variables
BUCKET_NAME = "healthcare-bucket-18082025"
CLAIMS_BUCKET_PATH = f"gs://{BUCKET_NAME}/landing/claims/*.csv"
BQ_TABLE = "vvns-bigquery.bronze_dataset.claims"
...
claims_df = (claims_df
                .withColumn("datasource", 
                              when(input_file_name().contains("clevelandclinic"), "hosCleve")
                             .when(input_file_name().contains("highmarkhealth"), "hoshigh").otherwise("None")))
